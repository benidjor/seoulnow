...
### 5-1. silent exit 의 root cause 분류 (Day 4 archive 확장)
...
### 5-2. uv extra mutual exclusive 의 venv 영구 영향
...
### 5-3. SMOKE_RUN_SECONDS 같은 design boundary 의 인지 의무
...
### 5-4. caffeinate ↔ at job 간격 의무 (운영 timing)
...
## 6. Day 8 진입 시 의무 사항 (운영 후속 inventory)
